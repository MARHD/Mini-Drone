...
8. Place padded double sided tape and clear glue in the following pattern on the top frame. 

<img src="/./Images/Instructions/20.jpeg" height="300">

9. Place the ESC onto the top of the frame as shown. keeping the edge with power wires flush with the frame and the ESC close but not touching the top left screw holding the Pixracer in. Hold the ESC in place until it wont move and let the glue dry...

<img src="/./Images/Instructions/19.jpeg" height="300">

10. Next place the wires of one motor at the top of the ESC, over the one beside it and the same for the bottom of the ESC, as seen below. i.e. cross the motors.

<img src="/./Images/Instructions/22.jpeg" height="300">

6. Ensure the middle holes of the motor mounts on the top frame have been deburred as described in: [Printing and Assembling plastic parts](./print_parts.md)

<img src="/./Images/Instructions/4_1.jpg" height="300">

11. Screw the motors in with the provided torx screws(shorter ones), keeping the wires aiming toward the center of the frame. Propellers shouldn't be attached (image was taken after the fact).

<img src="/./Images/Instructions/23.jpeg" height="300">

12. Tuck the excess motor wires into the cut out areas of the top frame.

<img src="/./Images/Instructions/24.jpeg" height="300">

13. Connect the signal wires to the large signal header on the Pixracer as follows, with the GND wire 2 places above the signal wires.

<img src="/./Images/Instructions/27_2.jpeg" height="300">

14. Move onto [Wiring and Mounting the receiver](./rec.md)
